...
/**
 * LABELS Etransactions
 */
define('Etransactions_LABEL_AMOUNT', 'Montant envoyé à Etransactions');
define('Etransactions_LABEL_ORDERID', 'Référence commande');
define('Etransactions_LABEL_NUMAPPEL', 'Numéro d’appel Etransactions');
define('Etransactions_LABEL_ERROR', 'Code retour de la transaction <br>(00000 code ok)');
define('Etransactions_LABEL_NUMTRANS', 'Numéro de transaction Etransactions');
define('Etransactions_LABEL_PAYSFRA', 'Code pays de la banque émettrice de la carte');
define('Etransactions_LABEL_IP', 'Code pays de l\'adresse IP de l\'internaute');
define('Etransactions_LABEL_CARTE', 'Type de carte retenu');
define('Etransactions_LABEL_TYPEPAIEMENT', 'Type de paiement retenu');
define('Etransactions_LABEL_SECURE', 'Garantie du paiement 3-D Secure');
define('Etransactions_LABEL_DATETRAITEMENT', 'Date de traitement de la transaction');
define('Etransactions_LABEL_SIXFIRST', 'Six premiers chiffres de la carte');
define('Etransactions_LABEL_TWOLAST', 'Deux derniers chiffres de la carte');
